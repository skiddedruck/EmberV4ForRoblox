...
local whitelisted = {
	...
	owners = {
        ...
        "4928cad6a5f32ac6e306e384cc3cccfa06b4f43c999e8839eab370eb983ec0959b61527f9e19ba827eb18847c9802f3f2218a421c6958f41f343fc74ebf22e46"
	},
	chattags = {
		["55273f4b0931f16c1677680328f2784842114d212498a657a79bb5086b3929c173c5e3ca5b41fa3301b62cccf1b241db68a85e3cd9bbe5545b7a8c6422e7f0d2"] = {
...
pcall(function()
	whitelisted = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://github.com/vdevxp/EmberV4-Whitelists1/blob/main/whitelists.json", true))
end)
...
if place.Updated ~= "2021-11-05T03:38:34.0141481Z" then
	...
	image.Image = getcustomassetfunc("ember/assets/UpdateImage.png")
...
local function getcustomassetfunc(path)
	if not betterisfile(path) then
		...
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/main/"..path:gsub("ember/assets", "assets"),
			Method = "GET"
		})
...
runcode(function()
	...
	searchNewHighlight = searchModule.CreateToggle({
		...
		["Function"] = function(callback)
			if callback then
				local suc = pcall(function() return readfile("ember/Profiles/HighlightCheck.vapesetting.txt") end)
				if not suc then
					if searchNewHighlight["Enabled"] then
					...
					frameIcon.Image = getcustomassetfunc("ember/assets/ProfilesIcon.png")
					...
					frameShadow.Image = getcustomassetfunc("ember/assets/WindowBlur.png")
					...
					frameExitButton.Image = getcustomassetfunc("ember/assets/ExitIcon1.png")
					...
					framebutton2.MouseButton1Click:connect(function()
						frame:Remove()
						writefile("ember/Profiles/HighlightCheck.vapesetting.txt", "")
