...
task.spawn(function()
	local function createannouncement(announcetab)
		...
		vapeiconicon.Image = getsynasset("ember/assets/VapeIcon.png")
	...
	task.spawn(function()
		pcall(function()
			if not isfile("ember/Profiles/bedwarsdata.txt") then
				local commit = "main"
				...
				writefile("ember/Profiles/bedwarsdata.txt", game:HttpGet("https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/"..commit.."/CustomModules/bedwarsdata", true))
			end
			local olddata = readfile("ember/Profiles/bedwarsdata.txt")
			...
			repeat
				...
				if newdata ~= olddata then
					...
					olddata = newdata
					writefile("ember/Profiles/bedwarsdata.txt", newdata)
				end
